...
export const counties: County[] = [
  ...
  },
  {
    ...
    hoursSummary: ["Mon–Thu · 8:00 AM – 5:00 PM", "Fri · 8:00 AM – 2:00 PM"],
    lunchClosure: "Beginning October 1, 2026 · Both locations remain open during the lunch hour.",
    ...
    clinicSites: [
      ...
      },
      {
        ...
        notes: [
          "Beginning October 1, 2026. WIC available 8:00 AM – 5:00 PM, Mondays – Fridays.",
          "Both locations remain open during the lunch hour.",
